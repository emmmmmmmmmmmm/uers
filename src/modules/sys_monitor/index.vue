<template>
  <div class="page-wrapper sys-monitor-wrap">
    ...
    <un-table
      ...
      >
        <un-table-column prop="op_time" label="日期"2 sortable width="180" align="center"></un-table-column>
...
export default un.component(
  {
    ...
    computed: {
      ...
      endPickerOptions(){
        return{
            disableDate:(item)=>{
            const currentDate = new Date(this.today + ' 00:00:00').getTime
            const startDate = this.opStartDate ? new Date(this.opStartDate + ' 00:00:00').getTime() : new Date(this.minDate + ' 00:00:00').getTime()
     ...
     minStartDate(){
      return this.formatDate(this.getOffsetMontnDate(new Date(), -6))
     }
    },
    created () {
    ...
    methods: {
      ...
      getOffsetMontnDate(baseDate,offsetMonth){
      ...
      initDefaulDates(){
        ...
        this.opStartDate = this.formatDate(this.getOffsetMontnDate(new Date(),-5))
      },
      handleSearch(){
