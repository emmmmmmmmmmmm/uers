module.exports = {
	'zh_CN': {
		...
		"approveCommentPlaceholder":"请输入审批意见(必填,最多10000字)",
		"approveCommentRequired":"审批意见不能为空",
		"approveCommentTooLong":"审批意见不能超过10000字",
		"approveSuccess":"审批成功",
		"approveFailed":"审批失败",
		"NO.":"序号",
		"exportExcel":"导出excel",
	...
	'en-US': {
		...
		"approveCommentPlaceholder":"Please enter approval comment (required, max 10000 characters)",
		"approveCommentRequired":"Approval comment is required",
		"approveCommentTooLong":"Approval comment cannot exceed 10000 characters",
